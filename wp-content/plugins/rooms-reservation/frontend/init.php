<?php
	...
	function rms_translate( $originString, $empty = null )
	{
		...
		$en_array = array(
			...
			"Connexion" => "Sign in",
			"La demande de réservation pour un séjour à la Fondation Hardt se déroule en 4 étapes, merci de compléter les champs suivants" => "Online registration is a 4-step process. Please complete the following fields.",
			...
			"Modifier" => "Edit",
			"Chambre" => "Room",
			"Voici le résumé de votre pré-réservation. Veuillez noter que votre demande de séjour à la Fondation Hardt doit encore faire l'objet d'une validation de notre part." => "Summary of your pre-booking. Please note that your request will have to be validated by the Foundation.",
			"Confirmer" => "Confirm",
