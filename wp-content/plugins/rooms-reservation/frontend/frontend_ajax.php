		...
		if( isset($_POST['action']) )
		{
			...
			switch ($_POST['action'])
			{
				...
				case "add_reservation_new_user":
					...
					{
						$user_id = createUser(isset($_POST['gimme_scolarship']));
					}
					else
					{
		...
		if( $_POST['gimme_scolarship'] )
		{
			...
			Hardt Foundation";
				...
				// Ajout usermeta
						...
						wp_mail( "info@the-agencies.ch", "Demande pour un séjour", $message_admin, $headers_admin); // a supprimer sur demande
						//wp_mail( "quentin.mathey@think-webdesign.ch", "Demande pour un séjour", $message_admin, $headers_admin);
